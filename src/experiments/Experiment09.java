...
public class Experiment09 {
	...
	public void run() {
		...
		System.out.println("Club Names which contains es \n------------");
		table.stream().filter(clubName-> clubName.getClub().contains("es"))
		.forEach(filterdData-> System.out.println(filterdData.getClub()));
