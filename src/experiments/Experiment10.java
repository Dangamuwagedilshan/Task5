...
public class Experiment10 {
	...
	class Efilter implements Predicate<Club>{
		
		public boolean test(Club name) {
			return name.getClub().contains("es");
		}
	}
	...
	public void run() {
		...
		table.stream().filter(new Efilter()).forEach(clb -> System.out.println(clb.getClub()));
